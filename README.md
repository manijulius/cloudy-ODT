...
* **Gravitational settling:** Gravitational settling is based on Stokes' formulation for terminal velocity, using the air density at its grid cell.
* **Turbulent transport:** The triplet map used to move the grid cell scalars is also used to move the particles and assume no eddy hopping
